...
public class GUIPlugin extends Plugin {
	public GUIPlugin() {
		this.clientPlugin = new ClientGUIPlugin();
		this.serverPlugin = new ServerGUIPlugin();
	}
	
	public class ClientGUIPlugin extends ClientUIPlugin {
	...
	public class ServerGUIPlugin extends ServerPlugin {}
}
